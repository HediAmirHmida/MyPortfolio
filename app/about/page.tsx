    ...
    <section className="space-y-10">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
        <div className="flex items-center gap-4">
          ...
          />
          <div>
            <h1 className="text-2xl sm:text-3xl font-semibold">Hedi Amir Hmida</h1>
        ...
        <div className="flex flex-wrap gap-3">
          <a href="/ResumeHmidaHediAmir.pdf" download className="px-3 py-1.5 rounded-md border border-black/10 dark:border-white/15 text-sm hover:bg-black/5 dark:hover:bg-white/10">Download CV</a>
          <a href="/contact" className="px-3 py-1.5 rounded-md border border-black/10 dark:border-white/15 text-sm hover:bg-black/5 dark:hover:bg-white/10">Contact</a>
          <a href="https://www.linkedin.com/in/hedi-amir-hmida-233339278" target="_blank" rel="noreferrer" className="px-3 py-1.5 rounded-md border border-black/10 dark:border-white/15 text-sm hover:bg-black/5 dark:hover:bg-white/10">LinkedIn</a>
        </div>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        <div className="rounded-lg border border-black/10 dark:border-white/10 p-5">
          <h3 className="text-base font-semibold mb-2">Quick facts</h3>
      ...
      <div className="rounded-lg border border-black/10 dark:border-white/10 p-5">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <div>
            <h3 className="text-sm font-medium text-black/70 dark:text-white/70 mb-2">Languages</h3>
            <div className="flex flex-wrap gap-2">
              {["Python", "C", "C++", "Java", "JavaScript", "TypeScript", "PHP", "Dart"].map((s) => (
                <span key={s} className="text-xs rounded-full px-2 py-1 border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5">
                  {s}
                </span>
              ))}
            </div>
          ...
          <div>
            <h3 className="text-sm font-medium text-black/70 dark:text-white/70 mb-2">Frontend</h3>
            <div className="flex flex-wrap gap-2">
          ...
          <div>
            <h3 className="text-sm font-medium text-black/70 dark:text-white/70 mb-2">Backend</h3>
            <div className="flex flex-wrap gap-2">
          ...
          <div>
            <h3 className="text-sm font-medium text-black/70 dark:text-white/70 mb-2">Databases</h3>
            <div className="flex flex-wrap gap-2">
          ...
          <div>
            <h3 className="text-sm font-medium text-black/70 dark:text-white/70 mb-2">Testing & QA</h3>
            <div className="flex flex-wrap gap-2">
          ...
          <div>
            <h3 className="text-sm font-medium text-black/70 dark:text-white/70 mb-2">DevOps & Tools</h3>
            <div className="flex flex-wrap gap-2">
        ...
        <div className="mt-4">
          <h3 className="text-sm font-medium text-black/70 dark:text-white/70 mb-2">Others</h3>
          <div className="flex flex-wrap gap-2">
      ...
      <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="space-y-4">
            <div>
              <div className="flex items-start justify-between mb-1">
                <h3 className="font-medium text-sm">Software Engineer Intern</h3>
                <span className="text-xs text-black/60 dark:text-white/60">Jul 2024 – Aug 2024</span>
              </div>
              <div className="text-sm text-black/70 dark:text-white/70 mb-2">Mammut Web Solutions • Tunisia</div>
            ...
            <div>
              <div className="flex items-start justify-between mb-1">
                <h3 className="font-medium text-sm">Software Development Intern</h3>
                <span className="text-xs text-black/60 dark:text-white/60">Jul 2023 – Aug 2023</span>
              </div>
              <div className="text-sm text-black/70 dark:text-white/70 mb-2">Mammut Web Solutions • Tunisia</div>
              <ul className="text-xs text-black/80 dark:text-white/80 space-y-1 list-disc list-inside">
        ...
        <div className="rounded-lg border border-black/10 dark:border-white/10 p-5">
          ...
          <div className="space-y-4">
            ...
            <div>
              <div className="font-medium text-sm">Computer Science Engineering Degree</div>
              <div className="text-sm text-black/70 dark:text-white/70">National School of Computer Science, Tunisia</div>
              <div className="text-xs text-black/60 dark:text-white/60">2022 - 2024</div>
            </div>
            <div>
              <div className="font-medium text-sm">Preparatory Degree for Engineering Studies</div>
              <div className="text-sm text-black/70 dark:text-white/70">Preparatory Institute for Engineering Studies of Monastir (IPEIM)</div>
              <div className="text-xs text-black/60 dark:text-white/60">2020 - 2022</div>
            </div>
          </div>
        </div>
      </div>
